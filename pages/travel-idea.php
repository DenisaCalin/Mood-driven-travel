...
<body>
    ...
    <div class="sticky-part">
      <div class="container d-flex align-items-center">
        ...
        <nav class="w-100">
          ...
          <?php if(isset($_SESSION['username']) && !empty($_SESSION['username'])) :?>
            <form class="auth-nav" action="../index.html" method="post">
  ...
  <!-- MODALS -->
  <div id="modal-signup" class="with-auth-modal modal fade">
        ...
        <div class="modal-body">
          <form id="signup-form">
            <div class="input-block">
              ...
              <input id="signup-username" class="custom-input" type="text" name="username" value=""
                placeholder="Username" required>
            </div>
            <div class="input-block">
              <span uk-icon="icon: mail"></span>
              <input id="signup-email" class="custom-input" type="email" name="email" value="" placeholder="Email"
                required>
            </div>
            <div class="input-block">
              <span uk-icon="icon: lock"></span>
              <input id="signup-password" class="custom-input" type="password" name="password" value=""
                placeholder="Choose password" required>
            </div>
            <button class="primary-btn filled" name="signup-submit">Create An Account</button>
          </form>

        </div>
        <div class="modal-footer">
          <div class="signup-agreement">
            By signing up you agree to our <a class="btn btn-link" data-toggle="modal"
              data-target="#termsAndConditionsModal">
              Terms and Conditions
            </a>
            and
            <a class="btn btn-link" data-toggle="modal" data-target="#privacyPolicyModal">
              Privacy Policy
            </a>
          </div>
        </div>
  ...
  <div id="modal-login" class="with-auth-modal modal fade">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
          <form id="login-form">
            <div class="input-block">
              <span uk-icon="icon: mail"></span>
              <input id="login-email" class="custom-input" type="email" name="email" value="" placeholder="Email"
                required>
            </div>
            <div class="input-block">
              <span uk-icon="icon: lock"></span>
              <input id="login-password" class="custom-input" type="password" name="password" value=""
                placeholder="Password" required>
            </div>
            <button class="primary-btn filled" name="login-submit">Log In</button>
          </form>
        </div>
      </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p>These terms and conditions outline the rules and regulations for the use of MoodDrivenTravel's
            Website, located at www.mooddriventravel.ro.</p>
          <p>By accessing this website we assume you accept these terms and conditions. Do not continue to
            use MoodDrivenTravel if you do not agree to take all of the terms and conditions stated on this
            page. Our Terms and Conditions
            were created with the help of the <a href="https://www.termsandconditionsgenerator.com">Terms
          ...
          <p>The following terminology applies to these Terms and Conditions, Privacy Statement and
            ...
            provision of the Company’s stated
          ...
          <p>We employ the use of cookies. By accessing MoodDrivenTravel, you agreed to use cookies in
            agreement with the MoodDrivenTravel's Privacy Policy.</p>
          <p>Most interactive websites use cookies to let us retrieve the user’s details for each visit.
            ...
            for people visiting our website. Some
            of our affiliate/advertising partners may also use cookies.</p>
          <h5><strong>License</strong></h5>
          <p>Unless otherwise stated, MoodDrivenTravel and/or its licensors own the intellectual property
            rights for all material on MoodDrivenTravel. All intellectual property rights are reserved. You
            may access this from
            MoodDrivenTravel for your own personal use subjected to restrictions set in these terms and
            conditions.</p>
          <p>You must not:</p>
          <ul>
          ...
          <p>Parts of this website offer an opportunity for users to post and exchange opinions and
            information in certain areas of the website. MoodDrivenTravel does not filter, edit, publish or
            review Comments prior to their presence
            on the website. Comments do not reflect the views and opinions of MoodDrivenTravel,its agents
            and/or affiliates. Comments reflect the views and opinions of the person who post their views
            and opinions. To the extent permitted
            by applicable laws, MoodDrivenTravel shall not be liable for the Comments or for any liability,
            ...
            website.</p>
          <p>MoodDrivenTravel reserves the right to monitor all Comments and to remove any Comments which
          ...
          <p>You hereby grant MoodDrivenTravel a non-exclusive license to use, reproduce, edit and authorize
          ...
          <p>We will approve link requests from these organizations if we decide that: (a) the link would
            ...
            does not have any negative records
            with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of
            MoodDrivenTravel; and (d) the link is in the context of general resource information.</p>
          <p>These organizations may link to our home page so long as the link: (a) is not in any way
            ...
            and its products or services; and (c)
          ...
          <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking
            to our website, you must inform us by sending an e-mail to MoodDrivenTravel. Please include your
            name, your organization name,
            contact information as well as the URL of your site, a list of any URLs from which you intend to
            link to our Website, and a list of the URLs on our site to which you would like to link. Wait
          ...
          <p>No use of MoodDrivenTravel's logo or other artwork will be allowed for linking absent a
          ...
          <p>We do not ensure that the information on this website is correct, we do not warrant its
            ...
            the material on the website is kept up
            to date.</p>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p>MoodDrivenTravel ("us", "we", or "our") operates the www.mooddriventravel.ro website (the
            "Service").</p>
          <p>This page informs you of our policies regarding the collection, use, and disclosure of personal
            ...
            Policy for MoodDrivenTravel is
            created with the help of the <a
              href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/">Free Privacy Policy
              Generator</a>.</p>
          ...
          <p>Cookies are files with small amount of data which may include an anonymous unique identifier.
            ...
            also used are beacons, tags, and
          ...
          <p>Your information, including Personal Data, may be transferred to — and maintained on —
            ...
            where the data protection laws may differ
            than those from your jurisdiction.</p>
          <p>If you are located outside Romania and choose to provide information to us, please note that we
            transfer the data, including Personal Data, to Romania and process it there.</p>
          ...
          <p>MoodDrivenTravel will take all steps reasonably necessary to ensure that your data is treated
            ...
            country unless there are adequate controls in place including the security of your data and
            other personal information.</p>
          <h5><strong>Disclosure Of Data</strong></h5>
          <h4><strong>Legal Requirements</strong></h4>
          <p>MoodDrivenTravel may disclose your Personal Data in the good faith belief that such action is
            necessary to:</p>
          <ul>
          ...
          <p>We may employ third party companies and individuals to facilitate our Service ("Service
            ...
            assist us in analyzing how our Service is
            used.</p>
          ...
          <p>Our Service may contain links to other sites that are not operated by us. If you click on a
            ...
            review the Privacy Policy of every site
            you visit.</p>
  ...
  <footer>
    <div class="container">
      <div class="row row-wrap">
              ...
              <div id="wrapper">
                <div id="car-body">
                  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    x="0px" y="0px" viewBox="0 0 545.6 313.5" style="enable-background:new 0 0 545.6 313.5;"
                    xml:space="preserve">
                    <g id="surf-board">
                    ...
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                      ...
                      <path id="inner" class="st5 inner-tire" d="M146.8,239c-4.1,0-7.3,3.2-7.3,7.2c0,4,3.3,7.2,7.3,7.2c0-2.3,0-4.7,0-7c2.8,0,4.7,0,7.3,0
                        ...
                        <animateTransform attributeType="xml" attributeName="transform" type="rotate"
                          from="360 146.3 245.9" to="0 146.3 245.9" begin="0s" dur="0.6s" repeatCount="indefinite" />
                      </path>
                    </svg>
                  </div> <!-- Wheel Front -->
                  <div class="wheel wheel-back">
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                      ...
                      <path id="inner_1_" class="st5 inner-tire" d="M408.8,239c-4.1,0-7.3,3.2-7.3,7.2c0,4,3.3,7.2,7.3,7.2c0-2.3,0-4.7,0-7c2.8,0,4.7,0,7.3,0
                          c0-0.1,0-0.2,0-0.2C416.1,242.2,412.9,239,408.8,239z">
                        <animateTransform attributeType="xml" attributeName="transform" type="rotate"
                          from="360 408.3 245.9" to="0 408.3 245.9" begin="0s" dur="0.6s" repeatCount="indefinite" />
                      </path>
                    </svg>
                  </div> <!-- Wheel Back -->
                </div> <!-- Wheel -->
                <div id="smoke">
                  <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 93.1 79.3"
                    style="enable-background:new 0 0 93.1 79.3;" xml:space="preserve">
                    <path class="st5"
                      d="M36.7,11c-1.8-8-7-10-7-10l-19-1c-17.8,8-8,29-8,29c5.5,5.5,17,7,17,7c-12.7,14.8-7,26-7,26c4,3.8,17,2,17,2v6c3.5,12,25,9,25,9c4.5-2,6-5,6-5l1-3h18c7.3-2.8,6-9,6-9l-1-9c11.3-7.8,8-25,8-25c-7.1-4-13.6-4.1-15.5-4c7-9-0.5,0-0.5,0l1-10c-9-6-16-8-16-8c-4.3-1.8-19-1-19-1L36.7,11z" />
                  </svg>
                </div> <!-- Smoke -->
                <div id="shadow">
                  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    xml:space="preserve">
                    <path class="st2"
                      d="M461.1,288.4H70.3c-5.8,0-10.5-4.7-10.5-10.5l0,0c0-5.8,4.7-10.5,10.5-10.5h390.8c5.8,0,10.5,4.7,10.5,10.5l0,0C471.6,283.7,466.8,288.4,461.1,288.4z" />
                  </svg>
                </div> <!-- Shadow -->
              </div>
            </li>
        ...
        <div class="col">
          <a class="heading-text logged-in" href="../pages/travel-moods.html">TRAVEL MOODS</a>
          <ul id="moods-list">
          </ul>
        </div>
        <div class="col">
  ...
  <script>
    ...
    var firebaseConfig = {
      apiKey: "AIzaSyDes4MNsMsbQlXcaxfasVUCD-RF5R0gtlg",
      authDomain: "dc-travel-mood.firebaseapp.com",
      databaseURL: "https://dc-travel-mood.firebaseio.com",
      projectId: "dc-travel-mood",
      storageBucket: "dc-travel-mood.appspot.com",
      messagingSenderId: "354399978499",
      appId: "1:354399978499:web:6d93b9b76e53b60e393a36",
      measurementId: "G-ZCHSFYLF15"
    };
    // Initialize Firebase
